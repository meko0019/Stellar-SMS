...
Revision ID: ea70b6cef721
Revises: 
Create Date: 2019-05-21 11:48:24.827360
...
def upgrade():
    ...
    op.create_index(op.f('ix_messages_recieved_at'), 'messages', ['recieved_at'], unique=False)
    op.create_index(op.f('ix_messages_time_created'), 'messages', ['time_created'], unique=False)
